...
1. **Local exact anchors**：ISCF-BSCA、TimeAlign、QDF、AMD、SimpleTM 复用 Main I 的 exact H720 checkpoints。相同 preprocessing、native H720 loader、metric 与 repetition aggregation 下，MSE/MAE 必须在绝对误差 $10^{-8}$ 内复现。SimpleTM 必须评估并平均全部三个 H720 native repetitions，禁止挑选一个有利 repeat。
