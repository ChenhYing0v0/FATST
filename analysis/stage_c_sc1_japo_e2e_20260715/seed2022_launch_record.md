...
| `finish` | `2026-07-15T12:01:51+08:00` |
| `matrix` | 5 datasets × 7 arms × seed2022；35/35 |
...
`400–456 MiB`。按seed2021同矩阵约26分钟的wall time，初始预计在`12:04 +08:00`附近完成；实际于
`12:01:51 +08:00`完成。runner随后自动对seed2021/2022执行冻结two-seed mean gate。

完成状态：70/70 two-seed artifacts通过audit，decision=`two_seed_mean_fail_stop_and_attribute`；seed2023未启动。
