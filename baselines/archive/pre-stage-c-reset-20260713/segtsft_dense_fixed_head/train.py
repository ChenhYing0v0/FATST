...
from model import SegTSFTDenseFixedHead
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SegTSFTDenseFixedHead Phase 0 baseline.")
...
def main() -> None:
    ...
    run_dir = Path(args.output_root) / "SegTSFTDenseFixedHead" / args.dataset / f"h{args.pred_len}" / f"seed{args.seed}"
