...
- `stage-c-d15-native-pcsd-direct-control.md`: 当前active protocol；PCSD-CF Step7B 60-run prelaunch与resource
  smoke通过，seed2021 validation-only remote正在3×3090运行；SC2、test与confirmation seeds仍false；
