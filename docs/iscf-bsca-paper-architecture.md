...
| `current_review_cursor` | writing=Sections 5--7 v0.2 author-fixed structure temporarily frozen；experiments=H5B fallback retained、H5D 48-profile three-GPU train/validation active、test=0 |
