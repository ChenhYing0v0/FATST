...
| `current_review_cursor` | writing=Section 3 v0.2 narrative refinement pending author review；experiments=H4K targeted 24-job training prelaunch；Method Figure 4 planned |
