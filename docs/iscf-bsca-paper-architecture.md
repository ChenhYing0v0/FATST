...
| `current_review_cursor` | Section 5 v0.8将5.7收敛为Figure 7-only presentation；5.6正文仍暂时留空 |
...
| `provisional_content` | Section 5 v0.8 with author-refined opening、5.1--5.5与5.7；5.7仅展示Figure 7，5.6 visible body pending redesign；Sections 6--7 prose；Method Figure 4 stable vector-asset synchronization |
| `authorization_source` | 2026-08-21用户要求5.7仅展示Figure 7、不展示Table 4；no new implementation/training/formal test |
