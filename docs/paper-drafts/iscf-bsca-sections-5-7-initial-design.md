...
| `version` | `v0.20-figure5-shared-header-grid` |
| `date` | `2026-08-22 Figure 5 panel-header alignment refinement` |
...
| `manuscript_prose` | Section 5 v0.10 drafted at `docs/paper-drafts/iscf-bsca-experiments-initial-draft.md`; Section 5.6正文与Figure 5 v5.3为author-review candidate；Sections 6--7 remain structural only |
| `experiment_change` | None; this document does not authorize implementation, remote training or formal test |
| `evidence_snapshot` | Main-I, corrected Main-II, Efficiency, Core-Ablation, Figure 5 v5.3 sample-specific scope/allocation behavior and Decoder-Transfer complete |
...
| Figure 5 | Sample-specific scope diversity and allocation behavior | Full-model validation diagnostics for Section 5.6 | v5.3 author-review candidate; canonical=`paper-figures/figure_5_scope_allocation_behavior.*` |
