...
| `version` | `v0.21-figure5-fixed-section5-6-v0-11` |
| `date` | `2026-08-22 Figure 5 freeze and Section 5.6 narrative refinement` |
| `review_status` | `Figure 5 v5.3 temporarily fixed usable; Section 5.6 v0.11 pending author review; remaining structural design unchanged` |
...
| `manuscript_prose` | Section 5 v0.11 drafted at `docs/paper-drafts/iscf-bsca-experiments-initial-draft.md`; Figure 5 v5.3 temporarily fixed usable，Section 5.6正文待author review；Sections 6--7 remain structural only |
