...
| `version` | `v0.30-section7-freeze` |
| `date` | `2026-08-24 Section 7 temporary freeze` |
| `review_status` | `Sections 5--7, Figure 5 v5.3 and the two-paragraph Conclusion temporarily fixed usable` |
...
| `manuscript_prose` | Section 5 v0.13 drafted at `docs/paper-drafts/iscf-bsca-experiments-initial-draft.md`; Section 6 v0.4 fixed at `docs/paper-drafts/iscf-bsca-discussion-initial-draft.md`; Section 7 v0.2 fixed at `docs/paper-drafts/iscf-bsca-conclusion-initial-draft.md`; Figure 5 v5.3 temporarily fixed usable |
...
This document remains the frozen argumentative architecture of the remaining manuscript. Sections 5--7 have manuscript-facing drafts and are temporarily fixed usable; none of these documents promotes evidence beyond the boundaries recorded below.
