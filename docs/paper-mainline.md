...
| `current_11_step` | Phase5-A3D：Step 6/7/8，验证 teacher-preserved nested primary interface |
...
| `current_gate` | Stage A3D narrative_gate 已通过；effectiveness_gate 要求优于 A3C/A2，并接近或超过 H1/H1C |
| `paper_core_status` | A3C 不通过 paper-core gate，只否定 row-slice warm-start；A3D 是当前 primary nested interface 主线 |
