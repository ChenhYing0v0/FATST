...
| `current_11_step` | paper consolidation；writing=Section 4 v0.4 path/allocation refinement through 4.6 pending author review；experiments=Main I frozen，Main II H720-prefix Tier A/B/C authorized，Step 7 local implementation active |
