...
| `active_experiment_step` | iTransformer-style Decoder-HPO v2 Step 7 prelaunch complete；70-run test-tuned search frozen |
...
| `next_action` | focused commit/push -> remote GPU/quota gate -> resource smoke -> 70-run three-GPU training launch；training期间test=0 |
