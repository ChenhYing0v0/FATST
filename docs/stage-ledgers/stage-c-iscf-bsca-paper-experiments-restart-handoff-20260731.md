...
| `formal_test_authorized` | false for iTransformer-style transfer；training manifest gate passed，test=0 |
| `next_action` | 等待作者决定是否授权iTransformer 15-checkpoint/60-cell完整formal test；不得按validation方向选择性测试 |
