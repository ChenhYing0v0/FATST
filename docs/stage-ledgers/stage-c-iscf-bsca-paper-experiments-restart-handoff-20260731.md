...
| `active_experiment_step` | H5B fallback frozen；H5C 54/54 training complete、immutable manifest frozen、Step 9 formal-test preflight |
...
| `formal_test_authorized` | true；一次完整54-checkpoint/216-row formal test，禁止partial execution |
| `next_action` | focused commit/push -> remote exact-commit/zero-artifact/GPU preflight -> 完整formal test |
