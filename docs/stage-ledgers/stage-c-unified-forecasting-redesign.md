...
| `active_candidates` | `ISCF-BSCA-v1` three-seed paper-core pass；paper architecture v0.3 landed |
...
| --- | --- |
| `current_step` | BSCA confirmation Step10 complete；paper architecture v0.3 Introduction P1--P4 consensus |
...
| --- | --- | --- |
| ISCF-BSCA paper architecture | `v0_3_intro_p1_p4_consensus` | continue Introduction P5--P6；freeze Evidence III experiment details later |
