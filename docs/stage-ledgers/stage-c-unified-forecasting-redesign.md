...
| --- | --- | --- |
| ISCF-BSCA paper architecture | `v0_44_section3_v0_7_temporarily_frozen` | Section 4 Method pending author direction；Main I/II claims depend on tuned eight-dataset tables |
