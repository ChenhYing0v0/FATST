...
| `active_question` | 写作流审阅Section 4 v0.6 BSCA training refinement并等待Figure 4 stable vector source；实验流Main I已hash冻结，Main II H720-prefix formal table已完成并对齐Main I展示，table registry已建立；下一步为ablation/transfer独立prelaunch gate |
| `source_evidence` | historical/source-faithful `A6-LBF-r256` |
| `mechanism_control` | same-seed end-to-end `ISCF-EQUAL` no-anchor control；A6只作carrier benchmark/reference |
| `active_candidates` | architecture family frozen；`ISCF-BSCA-v1`=exact ablation anchor；`ISCF-BSCA-MAIN-v1`=8-dataset tuned main candidate；Introduction v0.9与Section 3 v0.7 frozen；Section 4 v0.6 BSCA training refinement pending author review；Figure 4 visual design temporarily fixed |
...
| Field | Content |
| --- | --- |
| `current_11_step` | paper consolidation；writing=Section 4 v0.6 BSCA training refinement pending author review；experiments=Main I freeze complete，Main II Step 9 audit / Step 10 system benchmark pass |
...
| `writing_latest_decision` | `section4_v0_6_bsca_training_refinement_pending_author_review` |
...
| --- | --- | --- |
| ISCF-BSCA paper architecture | `v0_60_section4_v0_6_bsca_training_refinement` | author review Section 4 through 4.5；complexity moved to Section 5.4 analysis；Figure 4 vector source pending |
