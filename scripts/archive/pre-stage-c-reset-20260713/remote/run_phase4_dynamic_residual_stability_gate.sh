...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase4_dynamic_residual_stability_gate}"
LOG_ROOT="${LOG_ROOT:-${OUTPUT_ROOT}/_logs/phase4_dynamic_residual_stability_gate}"
SUPERVISION_STRATEGIES="${SUPERVISION_STRATEGIES:-dynamic_residual_stability_routing full_time_mse r3_prefix_risk}"
...
echo "phase4_dynamic_residual_stability_gate_start=$(date -Is)"
...
echo "phase4_dynamic_residual_stability_gate_done=$(date -Is)"
