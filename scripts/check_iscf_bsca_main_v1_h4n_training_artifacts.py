#!/usr/bin/env python3
"""Audit all Weather H4N train/validation artifacts before formal-test access."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs" / "iscf_bsca_main_v1_hpo_weather_h4n.json",
    )
...
def main() -> None:
    ...
    for job in jobs:
        ...
        directory = args.output_root / "trials" / "Weather" / trial_id / "seed2021"
        for filename in (
            "checkpoint.pt",
            "training_log.csv",
        ...
        expected = {
            ...
            "patience": job["early_stopping_patience"],
        }
    ...
    assert len(checkpoint_hashes) == 40
