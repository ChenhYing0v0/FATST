...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase2_future_state_alignment_repair}"
...
log_root="${OUTPUT_ROOT}/_logs/phase2_future_state_alignment_repair_gate"
outer_log="${OUTPUT_ROOT}/_logs/phase2_repair_gate_outer.log"
