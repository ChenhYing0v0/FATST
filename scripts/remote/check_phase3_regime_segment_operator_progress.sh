...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase3_regime_segment_operator}"
RUN_NAME="${RUN_NAME:-PatchEncoderRegimeSegmentTargetOperator}"
DATASETS="${DATASETS:-ETTm1 Weather ETTh2}"
TARGET_HORIZONS="${TARGET_HORIZONS:-96,720}"
SEED="${SEED:-2021}"
EPOCHS="${EPOCHS:-100}"
PID="${PID:-}"
...
log_root="${OUTPUT_ROOT}/_logs/phase3_regime_segment_operator_gate"
outer_log="${OUTPUT_ROOT}/_logs/phase3_regime_segment_operator_outer.log"
