...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase1_fixed_adapter}"
LOG_ROOT="${LOG_ROOT:-${OUTPUT_ROOT}/_logs/phase1_fixed_adapter_gate}"
...
echo "phase1_fixed_adapter_gate_start=$(date -Is)"
echo "cwd=$(pwd)"
...
wait
echo "phase1_fixed_adapter_gate_done=$(date -Is)"
