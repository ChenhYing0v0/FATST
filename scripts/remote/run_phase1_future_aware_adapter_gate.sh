...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase1_future_aware_adapter}"
LOG_ROOT="${LOG_ROOT:-${OUTPUT_ROOT}/_logs/phase1_future_aware_adapter_gate}"
...
models=(
  ...
  "PatchEncoderFixedHeadAdapter:baselines/patch_encoder_fixed_head_adapter/train.py:"
  "PatchEncoderFutureAwareAdapter:baselines/patch_encoder_future_aware_adapter/train.py:--align-weight ${ALIGN_WEIGHT} --recon-weight ${RECON_WEIGHT}"
)
datasets=("ETTh2" "ETTm1" "Weather")
horizons=("96" "192" "336" "720")
read -r -a gpu_ids <<< "${GPU_IDS}"

echo "phase1_future_aware_adapter_gate_start=$(date -Is)"
echo "cwd=$(pwd)"
...
wait
echo "phase1_future_aware_adapter_gate_done=$(date -Is)"
