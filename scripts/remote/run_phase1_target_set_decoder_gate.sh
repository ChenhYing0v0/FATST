...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase1_target_set_decoder}"
LOG_ROOT="${LOG_ROOT:-${OUTPUT_ROOT}/_logs/phase1_target_set_decoder_gate}"
...
echo "phase1_target_set_decoder_gate_start=$(date -Is)"
echo "cwd=$(pwd)"
...
wait
echo "phase1_target_set_decoder_gate_done=$(date -Is)"
