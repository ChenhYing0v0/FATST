...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase1_trajectory_basis_residual}"
LOG_ROOT="${LOG_ROOT:-${OUTPUT_ROOT}/_logs/phase1_trajectory_basis_residual_gate}"
...
models=(
  ...
  "PatchEncoderTrajectoryBasisResidual:baselines/patch_encoder_trajectory_basis_residual/train.py:--run-name PatchEncoderTrajectoryBasisResidual"
)
datasets=("ETTh2" "ETTm1" "Weather")
horizons=("96" "192" "336" "720")
read -r -a gpu_ids <<< "${GPU_IDS}"

echo "phase1_trajectory_basis_residual_gate_start=$(date -Is)"
echo "cwd=$(pwd)"
...
wait
echo "phase1_trajectory_basis_residual_gate_done=$(date -Is)"
