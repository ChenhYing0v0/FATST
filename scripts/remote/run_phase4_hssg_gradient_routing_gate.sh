...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase4_hssg_gradient_routing_gate}"
LOG_ROOT="${LOG_ROOT:-${OUTPUT_ROOT}/_logs/phase4_hssg_gradient_routing_gate}"
...
echo "phase4_hssg_gradient_routing_gate_start=$(date -Is)"
echo "cwd=$(pwd)"
...
wait
echo "phase4_hssg_gradient_routing_gate_done=$(date -Is)"
