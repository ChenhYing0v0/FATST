...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase5_timealign_hss_h0_prefix_gate}"
...
LOSS_MODES="${LOSS_MODES:-full multi-prefix balanced-step stochastic-prefix continuous-prefix}"
SEQ_LEN="${SEQ_LEN:-720}"
BATCH_SIZE="${BATCH_SIZE:-32}"
MAX_TRAIN_BATCHES="${MAX_TRAIN_BATCHES:-0}"
MAX_EVAL_BATCHES="${MAX_EVAL_BATCHES:-0}"
NUM_WORKERS="${NUM_WORKERS:-0}"
PREFIX_SAMPLES="${PREFIX_SAMPLES:-1}"
CONTINUOUS_MIN_PREFIX="${CONTINUOUS_MIN_PREFIX:-32}"
CONTINUOUS_PREFIX_STEP="${CONTINUOUS_PREFIX_STEP:-32}"
...
echo "phase5_timealign_hss_h0_prefix_gate_start=$(date -Is)"
echo "cwd=$(pwd)"
...
echo "continuous_min_prefix=${CONTINUOUS_MIN_PREFIX}"
echo "continuous_prefix_step=${CONTINUOUS_PREFIX_STEP}"
...
run_job() {
  ...
  run_name="TimeAlignOfficialUnified720_H0_${safe_loss_mode}_${CHECKPOINT_POLICY}"
...
echo "phase5_timealign_hss_h0_prefix_gate_done=$(date -Is)"
