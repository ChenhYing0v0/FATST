...
REMOTE_OUTPUT_ROOT="${REMOTE_OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase5_c1_global_anchored_multipatch_gate}"
ANALYSIS_ROOT="${ANALYSIS_ROOT:-analysis/phase5_c1_global_anchored_multipatch_gate_$(date '+%Y%m%d')}"
SKIP_ANALYSIS="${SKIP_ANALYSIS:-0}"

echo "sync_phase5_c1_global_anchored_multipatch_gate_start=$(date '+%Y-%m-%dT%H:%M:%S%z')"
