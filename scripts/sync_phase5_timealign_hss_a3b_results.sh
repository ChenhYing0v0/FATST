...
REMOTE_OUTPUT_ROOT="${REMOTE_OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase5_timealign_hss_a3b_nested_residual_gate}"
CHECKPOINT_POLICY="${CHECKPOINT_POLICY:-official-last}"
ANALYSIS_ROOT="${ANALYSIS_ROOT:-analysis/phase5_timealign_hss_a3b_nested_residual_gate_$(date '+%Y%m%d')}"
SEED="${SEED:-2021}"
...
A3_METRICS_CSV="${A3_METRICS_CSV:-analysis/phase5_timealign_hss_a3_interface_repair_20260701/phase5_timealign_hss_a3_metrics.csv}"
...
echo "sync_phase5_timealign_hss_a3b_start=$(date '+%Y-%m-%dT%H:%M:%S%z')"
