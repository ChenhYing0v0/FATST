...
REMOTE_OUTPUT_ROOT="${REMOTE_OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase5_timealign_hss_a3c_warm_started_nested_gate}"
CHECKPOINT_POLICY="${CHECKPOINT_POLICY:-official-last}"
ANALYSIS_ROOT="${ANALYSIS_ROOT:-analysis/phase5_timealign_hss_a3c_warm_started_nested_gate_$(date '+%Y%m%d')}"
SEED="${SEED:-2021}"
...
A3B_METRICS_CSV="${A3B_METRICS_CSV:-analysis/phase5_timealign_hss_a3b_nested_residual_gate_20260701/phase5_timealign_hss_a3b_metrics.csv}"
...
echo "sync_phase5_timealign_hss_a3c_start=$(date '+%Y-%m-%dT%H:%M:%S%z')"
