...
REMOTE_OUTPUT_ROOT="${REMOTE_OUTPUT_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/phase5_timealign_hss_a3d_teacher_preserved_nested_gate}"
CHECKPOINT_POLICY="${CHECKPOINT_POLICY:-official-last}"
ANALYSIS_ROOT="${ANALYSIS_ROOT:-analysis/phase5_timealign_hss_a3d_teacher_preserved_nested_gate_$(date '+%Y%m%d')}"
SEED="${SEED:-2021}"
...
A3C_METRICS_CSV="${A3C_METRICS_CSV:-analysis/phase5_timealign_hss_a3c_warm_started_nested_gate_20260701/phase5_timealign_hss_a3c_metrics.csv}"
...
echo "sync_phase5_timealign_hss_a3d_start=$(date '+%Y-%m-%dT%H:%M:%S%z')"
