...
REMOTE_ROOT="${REMOTE_ROOT:-/home/yingch/exp_outputs/r-2026-fatst/stage_c_d22c_target_access_v1}"
ANALYSIS_ROOT="${ANALYSIS_ROOT:-analysis/stage_c_post_d21_unconstrained_reset_20260720/d22c_target_access_v1}"
